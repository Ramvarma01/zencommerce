...
import { View, Text, TextInput, StyleSheet, TouchableOpacity, Alert, KeyboardAvoidingView, Platform, ScrollView, TouchableWithoutFeedback, Keyboard } from 'react-native';
  ...
  >
    ...
    keyboardShouldPersistTaps="handled"> */}
      ...
      <View>
        ...
        />
        <TextInput
          style={[styles.input, { backgroundColor: '#e0e0e0', color: '#000' }]}
          placeholder="Email"
          value={email}
          editable={false}
