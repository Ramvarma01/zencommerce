        ...
        <View style={styles.menuSection}>
          ...
          >
            ...
            <Text style={styles.menuText}>
              Edit Profile {user?.isGoogleUser ? "" : "/Password"}{" "}
            </Text>
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(profile)/shippingAddress")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(profile)/yourOrder")}
          >
          ...
          <TouchableOpacity
            style={styles.menuItem}
            onPress={() => router.push("/(profile)/helpAndSupport")}
          >
