  ...
  return (
    // <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: '100vh', gap: '20px', width: '100%'}}>
      ...
      <div style={{display: 'flex', flexDirection: 'column', height: '80vh', justifyContent: 'center', alignItems: 'center'}}>
        <div style={{padding: '50px', borderRadius: '10px', boxShadow: '0 0 10px 0 rgba(0, 0, 0, 0.1)', justifyContent: 'center', alignItems: 'center', display: 'flex', flexDirection: 'column', gap: '20px  ', backgroundColor: '#2D2D3F'}}>
      ...
      <form onSubmit={handleSubmit} style={{display: 'flex', flexDirection: 'column', gap: '16px', minWidth: '300px'}}>
        ...
        <input
          ...
          style={{padding: '10px', fontSize: '16px'}}
        />
        <button type="submit" className='button-primary' disabled={loading} style={{marginTop: '20px'}}>
